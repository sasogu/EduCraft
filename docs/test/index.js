...
function getEmbeddedGameSignConfigs() {
	return [
		...
		{ id: 'dofa', x: 24, z: -18, title: 'DO A FA', subtitle: 'Atrapa notas', url: '/embedded-game/EduMusic/html/dofa.html' },
		{ id: 'pitch-height', x: 30, z: -16, title: 'AGUDO/GRAVE', subtitle: 'Escucha alturas', url: '/embedded-game/EduMusic/html/pitch-height.html' },
		{ id: 'pitch-direction', x: 22, z: -20, title: 'SUBE/BAJA', subtitle: 'Direccion sonora', url: '/embedded-game/EduMusic/html/pitch-direction.html' },
		{ id: 'duration-choice', x: 14, z: -18, title: 'DURACION', subtitle: 'Largo o corto', url: '/embedded-game/EduMusic/html/duration-choice.html' },
		{ id: 'rhythm', x: 8, z: -16, title: 'RITMO', subtitle: 'TA SU TITI', url: '/embedded-game/EduMusic/html/rhythm.html' },
		{ id: 'rhythm-dictation', x: 16, z: -8, title: 'DICTADO R', subtitle: 'Escucha y elige', url: '/embedded-game/EduMusic/html/rhythm-dictation.html' },
		{ id: 'melody-dictation', x: 22, z: -8, title: 'DICTADO M', subtitle: 'Escucha y elige', url: '/embedded-game/EduMusic/html/melody-dictation.html' },
		...
		{ id: 'melody', x: 32, z: -10, title: 'MELODIA', subtitle: 'Secuencias', url: '/embedded-game/EduMusic/html/melody.html' },
